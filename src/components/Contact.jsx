      ...
      <Container>
        <ContainerContact>
          <Typography variant="h6">
            Would you like to have my contact?
          </Typography>
          <Icons>
            <ButtonIcon
              href="https://www.linkedin.com/in/cmacha2/"
              target="_blank"
              size="large"
            >
            ...
            <ButtonIcon
              href="https://twitter.com/cmacha2_08"
              target="_blank"
              size="large"
            >
          ...
          <a
            href="mailto:cmacha2.08@gmail.com"
            style={{ textDecoration: "none" }}
          >
            <Typography variant="h6" color="#0ee687">
